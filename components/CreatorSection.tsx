          ...
          <div className="space-y-4 text-center md:text-left flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 pt-1 text-xs">
              <a
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/[0.04] hover:bg-white/[0.09] text-red-400 hover:text-red-300 border border-white/10 font-semibold transition-all active:scale-95 shadow-sm"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/[0.04] hover:bg-white/[0.09] text-slate-200 hover:text-white border border-white/10 font-semibold transition-all active:scale-95 shadow-sm"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 text-white font-bold transition-all active:scale-95 shadow-md shadow-red-500/25"
              >
                <svg className="w-3.5 h-3.5 fill-none stroke-current" strokeWidth="2" viewBox="0 0 24 24">
